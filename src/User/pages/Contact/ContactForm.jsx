...
// import { resetSuccess } from '../../../redux/slices/contactSlice'
...
const ContactForm = () => {
    ...
    useEffect(() => {
        if (success) {
            ...
            const timer = setTimeout(() => dispatch(resetSuccess()), 3000); // Hide message after 3s
    ...
    return (
        <div className="flex h-[660px] mt-[3rem] md:flex-row flex-col md:w-full sm:w-[80%] w-[90%] rounded-[20px] " >
            ...
            <form method='POST' className="flex justify-between items-start flex-col gap-[2rem] w-full md:w-[50%] h-full bg-white p-[2rem] " >
                ...
                {/* Success Message */}
            {success && (
                <p className="text-green-600 mt-2 text-center text-2xl">
