...
import { useStateContext } from "../../contexts/ContextProvider"
 import aayan from '../../assets/aayan.jpg' // Assuming you have an image named aayan.png in assets folder
        ...
        <>
            <nav className="lg:flex lg:flex-col hidden justify-between min-h-[5rem] items-center bg-black text-white  " >
                <div className="w-full flex justify-between items-center py-[20px] px-[4rem] " >
                    <Link to="/" className="" >
                        {/* <h3 style={{ fontFamily: 'cursive' }} className=" text-[40px] font-bold cursor-pointer text-orange " >Aayan</h3> */}
                        <div className="mx-4 px-4 justify-center " >
                                      <img src={aayan} onClick={() => navigate('/')} alt="profileImage" className="w-[5rem] h-[5rem] cursor-pointer " />
                                </div>
                    </Link>
            ...
            <div className="flex lg:hidden w-full bg-black flex-col items-end sticky top-0 left-0 z-50 px-[2rem] py-[12px] " >
                <div className="flex justify-between w-full items-center " >
                    <Link to="home" className="" >
                        {/* <h3 onClick={() => navigate('/')} style={{ fontFamily: 'cursive' }} className=" text-3xl font-bold cursor-pointer text-orange " > Aayan</h3> */}
                         <div className="mx-4 px-4 justify-center " >
                                      <img src={aayan} onClick={() => navigate('/')} alt="profileImage" className="w-[5rem] h-[5rem] cursor-pointer " />
                                </div>
                    </Link>
